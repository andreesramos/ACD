...
modelo_ridge = Ridge(alpha=1.0) # Puedes ajustar alpha para cambiar la regularización
...
rmse = mse ** 0.5
print(f'RMSE con Regresión Ridge: {rmse:.2f}')
...
y_pred_sample = modelo_ridge.predict(df_sample[columnas_predictoras])
...
plt.title('Regresión Ridge - Predicción de Charges (Muestra de 30 Personas)')
